...
//! Autogenerated weights for ether_app
//!
...
// 50
// --output
// runtime/snowbridge/src/weights/ether_app_weights.rs
...
/// Weight functions for ether_app.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> ether_app::WeightInfo for WeightInfo<T> {
	fn burn() -> Weight {
